...
public class LinearProbingHashST<Key, Value> {
	...
	/**
	 * this fuction hashes the key and gives the index of the array.
	 *
	 * @param      key   The key
	 *
	 * @return     It returns the integer number.
	 * the returned value is the hashed value to the given key.
	 * the time complexity of the function is 1.
	 */
	...
	/**
	 * this function checks if the key is available in the table.
	 *
