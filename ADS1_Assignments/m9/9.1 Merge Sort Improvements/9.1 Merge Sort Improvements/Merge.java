...
class Merge {
    /**
     * below the index of 7 the insertion sort takes place.
     * as the time complexity decreases when insertion sort is
     * used under the index of 7
     */
    ...
    /**
     * this Method to merge two arrays.
    ...
    public void merge(final Comparable[] array, final Comparable[] aux,
        ...
        //assert is used as a validator in java.
